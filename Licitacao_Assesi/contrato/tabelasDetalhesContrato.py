...
def verificarTabelaVersaoJulho2024(soup,directory=''):
    tablesObj = {}
    ...
    contratoVersaoJulho2024(tables,directory)
def contratoVersaoJulho2024(table,directory):
    print("\tDownload arquivos de contratos")
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        result = executor.map(pecorrerDoc, lines)
    ...
    print("\t\tBaixou Arquivos de Doc"+ parentDirectory)

    gerarArquivo.criarCSV(dadosTabela, parentDirectory+"/Detalhes Doc");
def pecorrerDoc(lines):
